...
#pragma target 3.0
	...
	UNITY_INSTANCING_BUFFER_START(Props)
		...
		float4 _waveXmove = _waveXSize * waveSpeed * _WindForce;
		float4 _waveZmove = _waveZSize * waveSpeed * _WindForce;
		...
		v.vertex.xyz -= mul((float3x3)unity_WorldToObject, waveMove - _Wind * v.color.r * v.color.r * _WindForce).xyz;
